...
static inline void __sl_console_log(const __sl_str* msg, __sl_u64 flags) {
    const __sl_u8* bytes = msg != NULL ? msg->bytes : (const __sl_u8*)0;
    __sl_uint      len = msg != NULL ? msg->len : 0u;
    (void)__sl_platform_call(
        __sl_PlatformOp_CONSOLE_LOG, (__sl_u64)(uintptr_t)bytes, (__sl_u64)len, flags, 0, 0, 0, 0);
}
