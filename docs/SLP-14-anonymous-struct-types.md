...
- In particular, `context` clauses use `Type` (see SLP-12 alignment).
...
Out of scope in SLP-14 (see SLP-16):
...
### 3. Context compatibility (SLP-12 carve-out)

SLP-12 context satisfaction remains structural-by-required-fields and name-sensitive.
...
### 5. Compound literal interaction (SLP-13)
...
New diagnostics expected for SLP-14:
...
- Keep SLP-12 context compatibility as required-field satisfaction.
...
- Anonymous enums (proposed separately in SLP-16).
