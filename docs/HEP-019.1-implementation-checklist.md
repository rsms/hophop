...
Related proposal: `docs/HEP-019-pointer-slice-unification.md`.
...
- `hop build --output-format ast` output is stable and unambiguous for `*T` vs `*[T]`.
...
- [x] Update docs:
  - `docs/HEP-019-pointer-slice-unification.md`
  - `docs/HEP-019.1-implementation-checklist.md`
