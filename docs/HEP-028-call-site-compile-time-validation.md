# HEP-28 call-site compile-time validation primitives (completed)

## Summary

HEP-28 adds generic language/compiler primitives needed for library-defined, call-site compile-time
...
Current behavior blocks pure-HopHop call-site validation:
...
As a result, features like HEP-26 were forced into compiler and backend special-cases.
...
No new runtime dynamic indexing behavior is required by this HEP.
...
5. pure-HopHop format validation helper prototype using these primitives
