...
- [x] Update selector/indexing typing for VSS dependent fields:
  ...
  - from `&Packet` field `data` yields `&[Elem]`
- [x] Update diagnostic text and fix-it hints from SLP-2 forms to SLP-19 forms.
...
- [x] Update docs:
  - `docs/SLP-19-pointer-slice-unification.md`
  - `docs/SLP-19.1-implementation-checklist.md`
...
- [x] Add targeted suites for parser/typechecker/codegen paths changed by SLP-19.
