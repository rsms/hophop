# HEP-13 compound literals (completed)

## Summary

HEP-13 adds compound literals in two forms:
...
Current HopHop has no compound literal syntax. This makes value construction verbose and blocks
...
### 1.1 Interaction with HEP-14 anonymous aggregate types

HEP-14 keeps the explicit form unchanged: `TypeName{...}`.
...
- If field has default initializer (HEP-15), use that default.
...
var a = Config{ timeout_ms: 500 } // retries from default (HEP-15)
...
### 6. Context overlay value (HEP-12)
