# HEP-16 anonymous enums with contextual identification (draft)

## Summary

HEP-16 proposes anonymous enum types and contextual enum member literals:
...
Anonymous aggregate types in HEP-14 cover one-off struct/union shapes. Some APIs also need small
