...
- SLP-4 type functions (receiver sugar, overload groups, `x.len()`, `ma.new(...)`):
  `examples/slp4_type_functions.sl`
  - Check: `./_build/macos-aarch64-debug/slc check examples/slp4_type_functions.sl`
